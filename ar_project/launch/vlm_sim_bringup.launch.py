    ...
    orchestrator = TimerAction(period=34.0, actions=[
        ExecuteProcess(
            cmd=[
                ...
                '-p', f"camera_image_topic:={LaunchConfiguration('camera_image_topic').perform(context)}",
            ],
            env=env,
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('target_detect_conf', default_value='0.60'),
        ...
        DeclareLaunchArgument('detector_target_conf_default', default_value='0.60'),
